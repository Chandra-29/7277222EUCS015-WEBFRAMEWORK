package com.example.CW1.ChandramukiModel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class ChandramukiMedicine {
     ...
     public ChandramukiMedicine() {

     }

     public ChandramukiMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
