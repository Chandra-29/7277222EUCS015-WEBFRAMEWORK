...
@Entity
public class ChandramukiChildren {
     @Id
     private int babyId;
     ...
     public ChandramukiChildren() {

     }

     public ChandramukiChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
