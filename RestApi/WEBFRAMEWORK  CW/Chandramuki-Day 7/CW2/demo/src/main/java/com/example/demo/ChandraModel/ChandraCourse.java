...
public class ChandraCourse {
     ...
     public ChandraCourse() {

     }

     public ChandraCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
